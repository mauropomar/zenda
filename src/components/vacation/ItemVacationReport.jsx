...
export default function ItemVacationReport({ element }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <RenderSeparator />
            <View style={styles.row}>
                <StyledText align='left'>Días adicionales</StyledText>
                <StyledText align='right' fontWeight="bold">{element.daysAditional}</StyledText>
            </View>
            <RenderSeparator />
            <View style={styles.row}>
                <StyledText align='left'>Días regulares</StyledText>
                <StyledText align='right' fontWeight="bold">{element.daysRegular}</StyledText>
            </View>
            <RenderSeparator />
            <View style={styles.row}>
                <StyledText align='left'>Días Art.68</StyledText>
                <StyledText align='right' fontWeight="bold">{element.daysArt68}</StyledText>
            </View>
            <RenderSeparator />
            <View style={styles.row}>
